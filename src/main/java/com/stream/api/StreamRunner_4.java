	...
	public static void main(String[] args) {
		...
		System.out.println("All Match returned  "+
			persons.stream().allMatch(p-> {
				boolean flag = p.getCountry().equals("USPersonInfo");
				System.out.println("[allMatch -Country='US' pass #"+i++ + "| returns : " + flag);
				return flag;
			})
		);
		//In same way we can use nonmatch or anymatch method which is available in Stream Class.
