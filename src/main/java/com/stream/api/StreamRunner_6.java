	...
	public static void main(String[] args) {
		...
		System.out.println("All Match returned  "+
			persons.stream().filter(p-> {
				boolean flag = p.getWeight() > 50;
				System.out.println("[filter 1 - weight > 50 ] pass #"+i++ + "| returns :" + flag);
				return flag;
			})
			.filter(p-> {
				boolean flag = p.getAge() > 18;
				System.out.println("[filter 1 - age>18 ] pass #"+j++ + "| returns :" + flag);
				return flag;
			})
			.allMatch(p-> {
